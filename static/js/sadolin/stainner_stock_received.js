...
var stainner_sr_url = "http://127.0.0.1:4444/";
// var stainner_sr_url = "http://172.105.158.108:4444/";
...
function stock_view_all ()
    {
        ...
        req.open('post', stainner_sr_url+'stainner_stock_view_all',true)
        req.onload = function ()
            {
...
//     let req = new XMLHttpRequest();
//     req.open('post', stainner_sr_url+'stainner_stock_view_by_name',true)
//     req.onload = function ()
//         {
//             let results = JSON.parse(this.responseText);
//             if (! results || !results.length)
...
function stock_view_by_date_today ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', stainner_sr_url+'stainner_stock_view_by_date_today',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_view_by_date_date ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', stainner_sr_url+'stainner_stock_view_by_date_date',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
//     let req = new XMLHttpRequest();
//     req.open('post', stainner_sr_url+'stainner_stock_view_by_date_date_name',true)
//     req.onload = function ()
//         {
//             let results = JSON.parse(this.responseText);
//             if (! results || !results.length)
...
function stock_from_to_all ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', stainner_sr_url+'stainner_from_to_all',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
//     let req = new XMLHttpRequest();
//     req.open('post', stainner_sr_url+'stainner_from_to_name',true)
//     req.onload = function ()
//         {
//             let results = JSON.parse(this.responseText);
//             if (! results || !results.length)
...
function stock_last_week_all ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', stainner_sr_url+'stainner_last_week_all_data',true)
    req.onload = function ()
        {
            document.getElementById("stock-received-loader-last-week-all").style.display="none";
            let results = JSON.parse(this.responseText);
...
//     let req = new XMLHttpRequest();
//     req.open('post', stainner_sr_url+'stainner_last_week_name_data',true)
//     req.onload = function ()
//         {
//             let results = JSON.parse(this.responseText);
...
function stock_this_month_all ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', stainner_sr_url+'stainner_this_month_all_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
...
//     let req = new XMLHttpRequest();
//     req.open('post', stainner_sr_url+'stainner_this_month_by_name_data',true)
//     req.onload = function ()
//         {
//             let results = JSON.parse(this.responseText);
...
function stock_last_month_all ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', stainner_sr_url+'stainner_last_month_all_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
...
function stock_last_month_name ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', stainner_sr_url+'stainner_last_month_name_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
...
function save_show_all_data ()
{
    ...
    localStorage.setItem("stainner_all", data);
}
// function save_stock_view_by_name_data ()
// {
//     let data = document.getElementById ("stock-received-view-by-name-tbody").innerHTML;
//     localStorage.setItem("stainner_by_name", data);
// }

function save_by_date_today_data ()
{
    let data = document.getElementById ("stock-view-by-date-today-tbody").innerHTML;
    localStorage.setItem("stainner_date_today", data);
}
function save_date_date_data ()
{
    let data = document.getElementById ("date-date-tbody").innerHTML;
    localStorage.setItem("stainner_date_date", data);
}
// function save_date_date_name ()
// {
//     let data = document.getElementById ("date-date-name-tbody").innerHTML;
//     localStorage.setItem("stainner_date_date_name", data);
// }

function save_from_to ()
{
    let data = document.getElementById("from-to-all-tbody").innerHTML;
    localStorage.setItem("stainner_from_to",data);
}
// function save_from_to_name ()
// {
//     let data = document.getElementById("from-to-name-tbody").innerHTML;
//     localStorage.setItem("stainner_from_to_name",data);
// }
function save_show_last_week_all ()
{
    let data = document.getElementById ("last-week-all-tbody").innerHTML;
    localStorage.setItem("stainner_last_week_all", data);
}
// function save_show_last_week_name ()
// {
//     let data = document.getElementById ("last-week-name-tbody").innerHTML;
//     localStorage.setItem("stainner_last_week_name", data);
// }
function save_show_this_month_all ()
{
    let data = document.getElementById ("show-all-tbody").innerHTML;
    localStorage.setItem("stainner_dis_mth_all", data);
}
// function save_show_this_month_by_name_data ()
// {
//     let data = document.getElementById ("this-month-by-name-tbody").innerHTML;
//     localStorage.setItem("stainner_dis_mth_name", data);
// }
function save_show_last_month_all ()
{
    let data = document.getElementById ("last-month-all-tbody").innerHTML;
    localStorage.setItem("stainner_lst_mth_all", data);
}
function save_show_last_month_by_name_data ()
{
    let data = document.getElementById ("last-month-by-name-tbody").innerHTML;
    localStorage.setItem("stainner_lst_mth_name", data);
}

// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
function Load_Stock_Received_Offline_Data () 
{
    document.getElementById("show-all-tbody").innerHTML = localStorage.getItem("stainner_all");
    // document.getElementById("stock-received-view-by-name-tbody").innerHTML = localStorage.getItem("stainner_by_name");
    document.getElementById("stock-view-by-date-today-tbody").innerHTML = localStorage.getItem("stainner_date_today");
    document.getElementById("date-date-tbody").innerHTML = localStorage.getItem("stainner_date_date");
    // document.getElementById("date-date-name-tbody").innerHTML = localStorage.getItem("stainner_date_date_name");
    document.getElementById("from-to-all-tbody").innerHTML = localStorage.getItem("stainner_from_to")
    // document.getElementById("from-to-name-tbody").innerHTML = localStorage.getItem("stainner_from_to_name")
    document.getElementById("last-week-all-tbody").innerHTML = localStorage.getItem("stainner_last_week_all");
    // document.getElementById("last-week-name-tbody").innerHTML = localStorage.getItem("stainner_last_week_name");
    document.getElementById("this-month-all-tbody").innerHTML = localStorage.getItem("stainner_dis_mth_all");
    // document.getElementById("this-month-by-name-tbody").innerHTML = localStorage.getItem("stainner_dis_mth_name");
    // document.getElementById("last-month-all-tbody").innerHTML = localStorage.getItem("stainner_lst_mth_all");
    // document.getElementById("last-month-by-name-tbody").innerHTML = localStorage.getItem("stainner_lst_mth_name");
}
