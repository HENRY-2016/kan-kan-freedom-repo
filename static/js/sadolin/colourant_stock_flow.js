...
var colourant_sf_url = "http://127.0.0.1:4444/";   
// var colourant_sf_url = "http://172.105.158.108:4444/";
...
function stock_flow_all ()
    {
        ...
        req.open('post', colourant_sf_url+'colourant_stock_flow_view_all',true)
        req.onload = function ()
            {
...
function stock_flow_name ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', colourant_sf_url+'colourant_stock_flow_view_by_name',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_date_today ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', colourant_sf_url+'colourant_stock_flow_view_by_date_today',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_date_date ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', colourant_sf_url+'colourant_stock_flow_view_by_date_date',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_date_name_date ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', colourant_sf_url+'colourant_stock_flow_by_date_date_name',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_from_to_all ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', colourant_sf_url+'colourant_stock_flow_from_to_all',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_from_to_name ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', colourant_sf_url+'colourant_stock_flow_from_to_name',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_last_week_all()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', colourant_sf_url+'colourant_stock_flow_last_week_all_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_last_week_name ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', colourant_sf_url+'colourant_stock_flow_last_week_name_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_this_month_all ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', colourant_sf_url+'colourant_stock_flow_this_month_all_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_this_month_name ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', colourant_sf_url+'colourant_stock_flow_this_month_by_name_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
...
function stock_flow_last_month_all ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', colourant_sf_url+'colourant_stock_flow_last_month_all_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_last_month_name ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', colourant_sf_url+'colourant_stock_flow_last_month_name_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
...
function stock_status_all ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', colourant_sf_url+'colourant_stock_status_all_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
...
function stock_status_name ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', colourant_sf_url+'colourant_stock_status_name_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function save_stock_flow_this_month_by_name_data ()
{
    ...
    localStorage.setItem("colourant_stock_flow_dis_mth_name", data);
}
function save_stock_flow_last_month_all ()
{
    let data = document.getElementById ("stock-flow-last-month-all-tbody").innerHTML;
    localStorage.setItem("colourant_stock_flow_lst_mth_all", data);
}
function save_stock_flow_last_month_by_name_data ()
{
    ...
    localStorage.setItem("colourant_stock_flow_lst_mth_name", data);
}
...
function save_stock_status_all ()
{
    ...
    localStorage.setItem("colourant_stock_status_all", data);
}

function save_stock_status_name ()
{
    let data = document.getElementById ("stock-status-name-tbody").innerHTML;
    localStorage.setItem("colourant_stock_status_name", data);
}
...
{
    document.getElementById("stock-flow-all-tbody").innerHTML = localStorage.getItem("colourant_stock_flow_all");
    document.getElementById("stock-flow-view-by-name-tbody").innerHTML = localStorage.getItem("colourant_stock_flow_by_name");
    document.getElementById("stock-flow-view-by-date-today-tbody").innerHTML = localStorage.getItem("colourant_stock_flow_date_today");
    document.getElementById("stock-flow-date-date-tbody").innerHTML = localStorage.getItem("colourant_stock_flow_date_date");
    document.getElementById("stock-flow-date-date-name-tbody").innerHTML = localStorage.getItem("colourant_stock_flow_date_date_name");
    document.getElementById("stock-flow-from-to-all-tbody").innerHTML = localStorage.getItem("colourant_stock_flow_from_to")
    document.getElementById("stock-flow-from-to-name-tbody").innerHTML = localStorage.getItem("colourant_stock_flow_from_to_name")
    document.getElementById("stock-flow-last-week-all-tbody").innerHTML = localStorage.getItem("colourant_stock_flow_last_week_all");
    document.getElementById("stock-flow-last-week-name-tbody").innerHTML = localStorage.getItem("colourant_stock_flow_last_week_name");
    document.getElementById("stock-flow-this-month-all-tbody").innerHTML = localStorage.getItem("colourant_stock_flow_dis_mth_all");
    document.getElementById("stock-flow-this-month-by-name-tbody").innerHTML = localStorage.getItem("colourant_stock_flow_dis_mth_name");
    document.getElementById("stock-flow-last-month-all-tbody").innerHTML = localStorage.getItem("colourant_stock_flow_lst_mth_all");
    document.getElementById("stock-flow-last-month-by-name-tbody").innerHTML = localStorage.getItem("colourant_stock_flow_lst_mth_name");

    // STOCK STATUS
    document.getElementById("stock-status-all-tbody").innerHTML = localStorage.getItem("colourant_stock_status_all");
    document.getElementById("stock-status-name-tbody").innerHTML = localStorage.getItem("colourant_stock_status_name");
}
