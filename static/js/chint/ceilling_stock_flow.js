...
// var ceilling_sf_url = "http://127.0.0.1:4444/";   
var ceilling_sf_url = "http://172.105.158.108:4444/";
...
function stock_flow_name ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', ceilling_sf_url+'ceilling_stock_flow_view_by_name',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_date_name_date ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', ceilling_sf_url+'ceilling_stock_flow_by_date_date_name',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_from_to_name ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', ceilling_sf_url+'ceilling_stock_flow_from_to_name',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_last_week_name ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', ceilling_sf_url+'ceilling_stock_flow_last_week_name_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_this_month_name ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', ceilling_sf_url+'ceilling_stock_flow_this_month_by_name_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
...
function stock_flow_last_month_name ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', ceilling_sf_url+'ceilling_stock_flow_last_month_name_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
...
function stock_status_name ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', ceilling_sf_url+'ceilling_stock_status_name_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function save_stock_flow_view_by_name_data ()
{
    ...
    localStorage.setItem("ceilling_stock_flow_by_name", data);
}
...
function save_stock_flow_date_date_name ()
{
    ...
    localStorage.setItem("ceilling_stock_flow_date_date_name", data);
}
...
function save_stock_flow_from_to_name ()
{
    ...
    localStorage.setItem("ceilling_stock_flow_from_to_name",data);
}
...
function save_stock_flow_last_week_name ()
{
    ...
    localStorage.setItem("ceilling_stock_flow_last_week_name", data);
}
...
function save_stock_flow_this_month_by_name_data ()
{
    ...
    localStorage.setItem("ceilling_stock_flow_dis_mth_name", data);
}
...
function save_stock_flow_last_month_by_name_data ()
{
    ...
    localStorage.setItem("ceilling_stock_flow_lst_mth_name", data);
}
...
function save_stock_status_name ()
{
    ...
    localStorage.setItem("ceilling_stock_status_name", data);
}
...
function Load_Stock_Flow_Offline_Data () 
{
    ...
    document.getElementById("stock-flow-view-by-name-tbody").innerHTML = localStorage.getItem("ceilling_stock_flow_by_name");
    ...
    document.getElementById("stock-flow-date-date-name-tbody").innerHTML = localStorage.getItem("ceilling_stock_flow_date_date_name");
    document.getElementById("stock-flow-from-to-all-tbody").innerHTML = localStorage.getItem("ceilling_stock_flow_from_to")
    document.getElementById("stock-flow-from-to-name-tbody").innerHTML = localStorage.getItem("ceilling_stock_flow_from_to_name")
    document.getElementById("stock-flow-last-week-all-tbody").innerHTML = localStorage.getItem("ceilling_stock_flow_last_week_all");
    document.getElementById("stock-flow-last-week-name-tbody").innerHTML = localStorage.getItem("ceilling_stock_flow_last_week_name");
    document.getElementById("stock-flow-this-month-all-tbody").innerHTML = localStorage.getItem("ceilling_stock_flow_dis_mth_all");
    document.getElementById("stock-flow-this-month-by-name-tbody").innerHTML = localStorage.getItem("ceilling_stock_flow_dis_mth_name");
    document.getElementById("stock-flow-last-month-all-tbody").innerHTML = localStorage.getItem("ceilling_stock_flow_lst_mth_all");
    document.getElementById("stock-flow-last-month-by-name-tbody").innerHTML = localStorage.getItem("ceilling_stock_flow_lst_mth_name");

    // STOCK STATUS
    document.getElementById("stock-status-all-tbody").innerHTML = localStorage.getItem("ceilling_stock_status_all");
    document.getElementById("stock-status-name-tbody").innerHTML = localStorage.getItem("ceilling_stock_status_name");
}
