...
function Show_White_Switches_Sockets_Id ()
{
    document.getElementById("MCB-1P-Id").style.display="none";
    document.getElementById("MCB-2P-Id").style.display="none";
    document.getElementById("MCB-1P-Id").style.display="none";
    ...
    document.getElementById("Led-Surface-Panel-Lights-Id").style.display="none";
    document.getElementById("Gold_Switches_Sockets_Id").style.display="none";
    document.getElementById("White_Switches_Sockets_Id").style.display="block";
}
function Close_White_Switches_Sockets_Id (){document.getElementById("White_Switches_Sockets_Id").style.display="none";}
function OpenWhiteSwicthTab (){document.getElementById("white-socket-tab").style.display="none";document.getElementById("white-swicth-tab").style.display="block";}
function OpenWhiteSocketTab (){document.getElementById("white-swicth-tab").style.display="none";document.getElementById("white-socket-tab").style.display="block";}

function Show_Silver_Switches_Sockets_Id ()
{
    document.getElementById("MCB-1P-Id").style.display="none";
    document.getElementById("MCB-2P-Id").style.display="none";
    document.getElementById("MCB-1P-Id").style.display="none";
    ...
    document.getElementById("Gold_Switches_Sockets_Id").style.display="none";
    document.getElementById("White_Switches_Sockets_Id").style.display="none";
    document.getElementById("Silver_Switches_Sockets_Id").style.display="block";
}
function Close_Silver_Switches_Sockets_Id (){document.getElementById("Silver_Switches_Sockets_Id").style.display="none";}
function OpenSilverSwicthTab (){document.getElementById("silver-socket-tab").style.display="none";document.getElementById("silver-swicth-tab").style.display="block";}
function OpenSilverSocketTab (){document.getElementById("silver-swicth-tab").style.display="none";document.getElementById("silver-socket-tab").style.display="block";}


function Show_Gold_Switches_Sockets_Id ()
{
    document.getElementById("MCB-1P-Id").style.display="none";
    document.getElementById("MCB-2P-Id").style.display="none";
    document.getElementById("Led-Bulbs-Id").style.display="none";
    ...
    document.getElementById("White_Switches_Sockets_Id").style.display="none";
    document.getElementById("Silver_Switches_Sockets_Id").style.display="none";
    document.getElementById("Gold_Switches_Sockets_Id").style.display="block";
}
function Close_Gold_Switches_Sockets_Id (){document.getElementById("Gold_Switches_Sockets_Id").style.display="none";}
function OpenGoldSwicthTab (){document.getElementById("gold-socket-tab").style.display="none";document.getElementById("gold-swicth-tab").style.display="block";}
function OpenGoldSocketTab (){document.getElementById("gold-swicth-tab").style.display="none";document.getElementById("gold-socket-tab").style.display="block";}

function Show_Industrial_Metal_Clad_Id ()
{
    document.getElementById("MCB-1P-Id").style.display="none";
    document.getElementById("MCB-2P-Id").style.display="none";
    document.getElementById("MCB-1P-Id").style.display="none";
...
function Show_Led_Bulbs_Id ()
{
    ...
    document.getElementById("Gold_Switches_Sockets_Id").style.display="none";
    document.getElementById("Industrial_Metal_Clad_Id").style.display="none";
    document.getElementById("Led-Bulbs-Id").style.display="block";
}function Close_Led_Bulbs_Id (){document.getElementById("Led-Bulbs-Id").style.display="none";}

function Show_Led_Surface_Panel_Lights_Id ()
{
    document.getElementById("MCB-1P-Id").style.display="none";
    document.getElementById("MCB-2P-Id").style.display="none";
    document.getElementById("MCB-1P-Id").style.display="none";
    ...
    document.getElementById("Industrial_Metal_Clad_Id").style.display="none";
    document.getElementById("Led-Bulbs-Id").style.display="none";
    document.getElementById("Led-Surface-Panel-Lights-Id").style.display="block";
}function Close_Led_Surface_Panel_Lights_Id (){document.getElementById("Led-Surface-Panel-Lights-Id").style.display="none";}

function Show_MCB_1P_Id ()
{
    document.getElementById("White_Switches_Sockets_Id").style.display="none";
    document.getElementById("Silver_Switches_Sockets_Id").style.display="none";
    document.getElementById("Gold_Switches_Sockets_Id").style.display="none";
    ...
    document.getElementById("AC-Contactor-Id").style.display="none";
    document.getElementById("Main-Switch-Id").style.display="none";
    document.getElementById("MCB-1P-Id").style.display="block";
}function Close_MCB_1P_Id (){document.getElementById("MCB-1P-Id").style.display="none";}

function Show_MCB_2P_Id ()
{
    document.getElementById("White_Switches_Sockets_Id").style.display="none";
    document.getElementById("Silver_Switches_Sockets_Id").style.display="none";
    document.getElementById("Gold_Switches_Sockets_Id").style.display="none";
...
function Show_Main_Switch_Id ()
{
    ...
    document.getElementById("Cabels-Id").style.display="none";
    document.getElementById("AC-Contactor-Id").style.display="none";
    document.getElementById("Main-Switch-Id").style.display="block";
}function Close_Main_Switch_Id (){document.getElementById("Main-Switch-Id").style.display="none";}

function Show_Led_Flood_Lights_Id ()
{
    document.getElementById("White_Switches_Sockets_Id").style.display="none";
    document.getElementById("Silver_Switches_Sockets_Id").style.display="none";
    document.getElementById("Gold_Switches_Sockets_Id").style.display="none";
    ...
    document.getElementById("AC-Contactor-Id").style.display="none";
    document.getElementById("Main-Switch-Id").style.display="none";
    document.getElementById("Led-Flood-Lights-Id").style.display="block";
}function Close_Led_Flood_Lights_Id (){document.getElementById("Led-Flood-Lights-Id").style.display="none";}

function Show_Led_Ceiling_Lights_Id ()
{
    document.getElementById("White_Switches_Sockets_Id").style.display="none";
    document.getElementById("Silver_Switches_Sockets_Id").style.display="none";
    document.getElementById("Gold_Switches_Sockets_Id").style.display="none";
    ...
    document.getElementById("Main-Switch-Id").style.display="none";
    document.getElementById("Led-Flood-Lights-Id").style.display="none";
    document.getElementById("Led-Ceiling-Lights-Id").style.display="block";
}function Close_Led_Ceiling_Lights_Id (){document.getElementById("Led-Ceiling-Lights-Id").style.display="none";}

function Show_Cabels_Id ()
{
    document.getElementById("White_Switches_Sockets_Id").style.display="none";
    document.getElementById("Silver_Switches_Sockets_Id").style.display="none";
    document.getElementById("Gold_Switches_Sockets_Id").style.display="none";
    ...
    document.getElementById("Led-Flood-Lights-Id").style.display="none";
    document.getElementById("Led-Ceiling-Lights-Id").style.display="none";
    document.getElementById("Cabels-Id").style.display="block";
}function Close_Cabels_Id (){document.getElementById("Cabels-Id").style.display="none";}
