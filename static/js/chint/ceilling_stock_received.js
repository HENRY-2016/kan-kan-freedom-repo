...
// var ceilling_sr_url = "http://127.0.0.1:4444/";
var ceilling_sr_url = "http://172.105.158.108:4444/";
...
function stock_view_by_date_name_date ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', ceilling_sr_url+'ceilling_stock_view_by_date_date_name',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_from_to_name ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', ceilling_sr_url+'ceilling_from_to_name',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_last_week_name ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', ceilling_sr_url+'ceilling_last_week_name_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
...
function stock_this_month_name ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', ceilling_sr_url+'ceilling_this_month_by_name_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
...
function stock_last_month_name ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', ceilling_sr_url+'ceilling_last_month_name_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
...
function save_stock_view_by_name_data ()
{
    ...
    localStorage.setItem("ceilling_by_name", data);
}
...
function save_date_date_name ()
{
    ...
    localStorage.setItem("ceilling_date_date_name", data);
}
...
function save_from_to_name ()
{
    ...
    localStorage.setItem("ceilling_from_to_name",data);
}
...
function save_show_last_week_name ()
{
    ...
    localStorage.setItem("ceilling_last_week_name", data);
}
...
function save_show_this_month_by_name_data ()
{
    ...
    localStorage.setItem("ceilling_dis_mth_name", data);
}
...
function save_show_last_month_by_name_data ()
{
    ...
    localStorage.setItem("ceilling_lst_mth_name", data);
}
...
function Load_Stock_Received_Offline_Data () 
{
    ...
    document.getElementById("stock-received-view-by-name-tbody").innerHTML = localStorage.getItem("ceilling_by_name");
    ...
    document.getElementById("date-date-name-tbody").innerHTML = localStorage.getItem("ceilling_date_date_name");
    document.getElementById("from-to-all-tbody").innerHTML = localStorage.getItem("ceilling_from_to")
    document.getElementById("from-to-name-tbody").innerHTML = localStorage.getItem("ceilling_from_to_name")
    document.getElementById("last-week-all-tbody").innerHTML = localStorage.getItem("ceilling_last_week_all");
    document.getElementById("last-week-name-tbody").innerHTML = localStorage.getItem("ceilling_last_week_name");
    document.getElementById("this-month-all-tbody").innerHTML = localStorage.getItem("ceilling_dis_mth_all");
    document.getElementById("this-month-by-name-tbody").innerHTML = localStorage.getItem("ceilling_dis_mth_name");
    // document.getElementById("last-month-all-tbody").innerHTML = localStorage.getItem("ceilling_lst_mth_all");
    // document.getElementById("last-month-by-name-tbody").innerHTML = localStorage.getItem("ceilling_lst_mth_name");
}
